...
import { ConfigSummaryInn, ConfigSummaryOuter, ConfigTotalBox, LableValue } from "./style";

function ConfigueMoreInformation({sendDataToParent,totalPrice,tabData} ) {
  ...
  }, [purposeOfInquiry, projectName, projectLocation, competitor, productApplications, statementOne, statementTwo, sendDataToParent]);
...
export default ConfigueMoreInformation;
