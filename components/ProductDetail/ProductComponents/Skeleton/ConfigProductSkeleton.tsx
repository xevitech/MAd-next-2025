...
export default function ConfigProductSkeleton() {
  return (
    <Box sx={{ width: "94%", margin: "0 auto" }}>
      <Grid container spacing={{ xs: 2 }}>
        ...
        <Grid item xs={12} sm={12} md={12} lg={8.9} xl={9.5}>
          <Grid container spacing={{ xs: 1, sm: 1, lg: 3 }}>
          ...
          <Box sx={{ marginTop: "24px", marginLeft: "16px" }}>
            <Box
              sx={{
                display: "flex",
                alignItems: "center",
        ...
        <Grid item xs={12} sm={12} md={12} lg={3.1} xl={2.5}>
          <Box
            sx={{
              padding: "10px",
          ...
          >
            ...
            >
              ...
              >
                <Skeleton
                  variant="circular"
                  animation="wave"
                  sx={{ height: "27px", width: "27px", borderRadius: "50%" }}
                />
                <Skeleton
                  variant="text"
                  animation="wave"
            ...
            <Box sx={{ marginTop: "16px" }}>
              ...
              <Box>
                <Divider
                  sx={{ marginTop: "8px", backgroundColor: "#dddddd" }}
                />
              </Box>
            </Box>
            <Box
