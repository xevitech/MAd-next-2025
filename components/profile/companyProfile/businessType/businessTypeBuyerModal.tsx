...
import { SelectedBusinessBtnOutline, SaveBuyerLink } from "./styles";
...
export const BusinessTypeBuyerModal = (props: any) => {
  const {
    defaultData,
    changeMode,
    toggleMode,
...
const [isSelected,setIsSelected]=useState(false);
  ...
  const SaveValues = async () => {
    ...
    let dataTosend = user_info?.type == "buyer" && {
  ...
  return (
    <ContentInnerContainer breakPoints={breakPoints}>
      ...
      <OuterContainer style={{ marginTop: "0px" }}>
        {mode == "edit" ? (
          <>
