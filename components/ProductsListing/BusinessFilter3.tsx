import {
  ...
  // ,checkedBusiness1    checkedBusiness1:string[]
  const BusinessFilter3: React.FC<BusinessFilterProps> = ({ onChange  }) => {
...
// if(checkedBusiness)  {
// React.useEffect(() => {
//   dispatch(MpFiltered({businessFilters1:checkedBusiness}));
// }, [])
// }
    ...
    const addQueryParams = (id) => {
      ...
      console.log("Updated Checked Business:", id);
      // dispatch(bdsm(id));
      // sessionStorage.setItem("checkedBusiness", JSON.stringify(id))
      onChange(id);
      // sessionStorage.setItem("cbc", JSON.stringify(id));
    };
  ...
  export default BusinessFilter3;
