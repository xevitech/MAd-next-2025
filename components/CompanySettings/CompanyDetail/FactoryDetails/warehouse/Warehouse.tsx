...
import WarehouseSkeleton from "../CompanyfacilitySkeleton/WarehouseSkeleton";
  ...
  const getCompanyData = async () => {
    try {
      ...
      if (fetchedData) {
        const parsedData = JSON.parse(fetchedData);
        if (
          Array.isArray(parsedData?.warehouse) &&
          parsedData.warehouse.length > 0
        ) {
          parsedData.warehouse.forEach((storeEntry) => {
            if (
              Array.isArray(storeEntry.warehouseData) &&
              storeEntry.warehouseData.length > 0
            ) {
              setData(storeEntry.warehouseData);
              setFormBlocks(storeEntry.warehouseData);
    ...
    validationSchema: Yup.object().shape({
      forms: Yup.array().of(
        Yup.object().shape({
          ...
          wareHouseVolume: Yup.string().required(
            "Please select warehouse volume"
          ),
                                ...
                                <Grid item xs={12} sm={12} md={10} lg={10}>
                                  <DataRowValue>
                                    <TextField
                                      ...
                                      fullWidth
                                      name={`forms[${index}].wareHouseName`}
                                      value={
                                      ...
                                      onChange={(e) => {
                                        ...
                                        if (inputValue.length <= 100) {
                                          ...
                                          formik.setFieldError(
                                            `forms[${index}].wareHouseName`,
                                            "Warehouse name content is too long. Please limit it to 100 character."
                                          );
                                        }
                            ...
                            <Grid
                              ...
                              sx={{
                                alignItems:
                                  ...
                                  (formik.touched.forms?.[index]
                                    ?.noOfProducts &&
                                    formik.errors.forms?.[index]?.noOfProducts)
                                    ? "baseline"
                                    : "center",
                              }}
                            >
                                          ...
                                          <AstricksMark>
                                            ...
                                            *
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Select the range that best describes the total storage capacity of your warehouse in cubic meters."
                                            >
                                          ...
                                          <AstricksMark>
                                            ...
                                            *
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Enter the total number of distinct products stored in your warehouse."
                                            >
                                              <HelpOutlineOutlinedIcon />
                                            </LightTooltip>
                                          </AstricksMark>
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (regex.test(value)) {
                                                if (value.length <= 8) {
                                                  ...
                                                  formik.setFieldError(
                                                    `forms[${index}].noOfProducts`,
                                                    "No. of products value content is too long. Please limit it to 8 digit."
                                                  );
                                                }
                                                formik.setFieldTouched(
                                                  `forms[${index}].noOfProducts`,
                                ...
                                <DataRowHere className="editview">
                                  ...
                                  >
                                    <Grid item xs={12} sm={12} md={4}>
                                      <DataRowTitle>
                                        <Typography>
                                          Country<AstricksMark> *</AstricksMark>
                                        </Typography>
                                      </DataRowTitle>
                                    </Grid>
                                    <Grid item xs={12} sm={12} md={8}>
                                          ...
                                          <AstricksMark>
                                            ...
                                            *
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Select the region, state, or province where your warehouse is located from the dropdown list."
                                            >
                                              <HelpOutlineOutlinedIcon />
                                            </LightTooltip>
                                          </AstricksMark>
                                          ...
                                          <AstricksMark>
                                            ...
                                            *
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Enter the complete street address of your warehouse, including building number and street name."
                                            >
                                              <HelpOutlineOutlinedIcon />
                                            </LightTooltip>
                                          </AstricksMark>
                                        ...
                                        <Typography>
                                          ...
                                          <AstricksMark>
                                            ...
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Enter the latitude and longitude coordinates of your warehouse for accurate mapping."
                                            >
                                              <HelpOutlineOutlinedIcon />
                                            </LightTooltip>
                                          </AstricksMark>
                                          ...
                                          <AstricksMark>
                                            ...
                                            *
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Choose the range that represents the total number of staff dedicated to Quality Assurance (QA) in your warehouse."
                                            >
                                              <HelpOutlineOutlinedIcon />
                                            </LightTooltip>
                                          </AstricksMark>
                                          ...
                                          onChange={(e) => {
                                            ...
                                            if (regex.test(value)) {
                                              if (value.length <= 8) {
                                                ...
                                                formik.setFieldError(
                                                  `forms[${index}].noOfQaStaff`,
                                                  "No. of QA Staff content is too long. Please limit it to 8 digit."
                                                );
                                              }
                                              formik.setFieldTouched(
                                                `forms[${index}].noOfQaStaff`,
                                          ...
                                          <AstricksMark>
                                            ...
                                            *
                                            <LightTooltip
                                              ...
                                              disableInteractive
                                              placement="top"
                                              title="Specify the total number of units stored in your warehouse over the last year."
                                            >
                                              <HelpOutlineOutlinedIcon />
                                            </LightTooltip>
                                          </AstricksMark>
                                          ...
                                          onChange={(e) => {
                                            ...
                                            if (regex.test(value)) {
                                              if (value.length <= 10) {
                                                ...
                                                formik.setFieldError(
                                                  `forms[${index}].annualStoreValue`,
                                                  "Annual stored unit content is too long. Please limit it to 10 digits."
                                                );
                                              }
                                              formik.setFieldTouched(
                                                `forms[${index}].annualStoreValue`,
          ...
          formik?.values?.forms.slice(0, visibleCount).map((form, index) => (
            <Box sx={{ padding: "0px" }} key={index}>
              {!editMode && (
                <>
                  {loader ? (
                    <SeparationSkeleton className="spacing3">
                      <WarehouseSkeleton></WarehouseSkeleton>
                    </SeparationSkeleton>
                  ) : (
                    data?.length > 0 && (
...
export default ManufecturerWareHouse;
