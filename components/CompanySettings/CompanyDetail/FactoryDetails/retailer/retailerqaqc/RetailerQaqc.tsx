...
export default function RetailerQaqc({}) {
  ...
  const agent_respresent_qaqc =
    companyDetails?.qaqc_rnd?.retailer_qaqc || null;
  ...
  try {
    ...
    testingImageUrl = agent_image?.Retailer.values?.testing_certificate;
  } catch (error) {}
  ...
  try {
    ...
    inspecting_parties = agent_list.Retailer.values.inspecting_parties;
    first_pass_yield = agent_list.Retailer.values.first_pass_yield;
    certificate_level_quality =
      agent_list.Retailer.values.certificate_level_quality;
    no_of_staff = agent_list.Retailer.values.no_of_staff;
  } catch (error) {}
  ...
  let formik: any = useFormik({
    initialValues: {
      testing_certificate: agent_respresent_qaqc
        ? JSON.parse(agent_respresent_qaqc)?.Retailer?.values
            ?.testing_certificate
        : [],
