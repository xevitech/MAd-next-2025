...
export default function AgentRepresentative({}) {
  ...
  const agent_respresent_qaqc = companyDetails?.qaqc_rnd?.other_qaqc || null;
  ...
  try {
    ...
    testingImageUrl = agent_image?.Other.values?.testing_certificate;
  } catch (error) {}
  ...
  try {
    ...
    inspecting_parties = agent_list.Other.values.inspecting_parties;
    first_pass_yield = agent_list.Other.values.first_pass_yield;
    certificate_level_quality =
      agent_list.Other.values.certificate_level_quality;
    no_of_staff = agent_list.Other.values.no_of_staff;
  } catch (error) {}
  ...
  let formik: any = useFormik({
    initialValues: {
      testing_certificate: agent_respresent_qaqc
        ? JSON.parse(agent_respresent_qaqc)?.Other?.values?.testing_certificate
        : [], 
