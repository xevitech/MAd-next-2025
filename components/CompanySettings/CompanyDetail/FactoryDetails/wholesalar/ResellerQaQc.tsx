...
import { AstricksMark, ButtonModeHere, CancelTextWithIcon, CompanyFacilityData, CompanyFacilityInnContainerQAQCnRND, DataRowHere, DataRowTitle, DataRowValue, EditBrowseIcon, EditBrowseText, EditModeBoxContainer, EditSaveIcons, EditSaveIcons1, EditUpImagesStack, SavebtnBox, SaveTextWithIcon, SelectedEditImg, SelectedEditSection, SubHeadingPage, TypographyTitle, UpImageName, UploadImageCol, UploadImagesRow } from "../style";
...
export default function AgentRepresentative({}) {
  ...
  const agent_respresent_qaqc = companyDetails?.qaqc_rnd?.reseller_qaqc || null;
  ...
  try {
    ...
    testingImageUrl = agent_image?.Reseller.values?.testing_certificate;
  } catch (error) {}
  ...
  try {
    ...
    inspecting_parties = agent_list.Reseller.values.inspecting_parties;
    first_pass_yield = agent_list.Reseller.values.first_pass_yield;
    certificate_level_quality =
      agent_list.Reseller.values.certificate_level_quality;
    no_of_staff = agent_list.Reseller.values.no_of_staff;
  } catch (error) {}
  ...
  let formik: any = useFormik({
    initialValues: {
      testing_certificate: agent_respresent_qaqc
        ? JSON.parse(agent_respresent_qaqc)?.Reseller?.values?.testing_certificate
        : [], 
                                      ...
                                      <TextField
                                        ...
                                        onChange={(e) => {
                                          ...
                                          if (!updatedValue.length) {
                                            ...
                                            formik.setFieldError("inspecting_parties", "This field cannot be empty");
                                          } else {
                                            formik.setFieldError("inspecting_parties", "");
                                          }
                                        }}
                ...
                {inspecting_parties && (
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <DataRowHere>
                        <Grid container spacing={1} alignItems={"center"}>
                          <Grid item xs={12} sm={12} md={4} lg={2} className="">
                            <DataRowTitle>
                              <Typography>Testing Certificates</Typography>
                            </DataRowTitle>
                          </Grid>
                          <Grid item xs={12} sm={12} md={8} lg={9} className="">
                            <DataRowValue>
                              <UploadImagesRow>
                        ...
                        <Grid item xs={12} sm={12} md={6}>
                          <DataRowHere>
                            <Grid container spacing={1}>
                              ...
                              <Grid item xs={12} sm={12} md={8}>
                                <DataRowValue>
                                  <Typography sx={{gap:'12px'}}>
                                  {inspecting_parties.length > 1 ? inspecting_parties.join(","):inspecting_parties}
