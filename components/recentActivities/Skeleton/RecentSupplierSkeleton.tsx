...
import {
  ...
  OuterContainer,
  TableWishlist,
} from "@/components/SellerTools/styles";
import { Box, Skeleton } from "@mui/material";
import { DataGridPro } from "@mui/x-data-grid-pro";
import React from "react";

export default function RecentSupplierSkeleton() {
  const columns: any = [
    {
      field: "serial_no",
      headerName: <Skeleton animation="wave" variant="text" width={50} height={'30px'} />,
      flex: 0.2,
      headerAlign: "center",
      align: "center",
      renderCell: (cellValues) => {
        return <Skeleton animation="wave" variant="text" width={20} height={'30px'} />;
      },
    },
    {
      field: "supplier",
      headerName: <Skeleton animation="wave" variant="text" width={100} height={'30px'} />,
      minWidth: 100,
      flex: 1,
      renderCell: (params) => {
        return <Skeleton animation="wave" variant="text" width={80} height={'30px'} />;
      },
    },
    {
      field: "company_type",
