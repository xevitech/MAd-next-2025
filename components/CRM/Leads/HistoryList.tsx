                  ...
                  <HistoryStackInn key={subIndex}>
                      ...
                      <Iconcontainer
                        sx={
                          subhistory?.type == "info"
                            ...
                            : subhistory?.type == "enquiry"
                            ? { backgroundColor: "#DB3685" }
                            ...
                            : subhistory?.type == "email"
                            ? { backgroundColor: "#6E8F44" }
                            : subhistory?.type == "meetings"
                            ? { backgroundColor: "#D7282F" }
                            : { backgroundColor: "#6E8F44" }
                        }
                      >
                    ...
                    <HistoryContentContainer>
                      <div className="LeftLine">
                        {subhistory?.history?.length > 0 &&
                          subhistory?.history?.map((rows, rowsIndex) => (
