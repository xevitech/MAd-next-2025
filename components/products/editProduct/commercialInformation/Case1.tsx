...
import { useStyles } from "@/components/products/editProduct/commercialInformation/styles";
...
function Case1({
  ...
  return (
    <CommercialCases>
                    ...
                    return (
                      <>
                        <TextField
                          ...
                          error={
                            dataExist ||
                            (formik?.errors?.caseOneData && selectedCountries.length === 0) ||
                            maxError
                          }
      ...
      {selectedCountries?.length > 0 && selectedOrigin == "country" && (showHideCountry == 1 || showHideTerritory == 1) && (
        <Box
          sx={{
          ...
          <FormControl>
            ...
            >
              <FormControlLabel
                ...
                label={
                  <div
                    dangerouslySetInnerHTML={{ __html: `${countryLabels[0]}` }}
                  ></div>
                }
              ...
              <FormControlLabel
                ...
                label={
                  <div
                    dangerouslySetInnerHTML={{ __html: `${countryLabels[1]}` }}
                  ></div>
                }
              ...
              <FormControlLabel
                ...
                label={
                  <div
                    dangerouslySetInnerHTML={{ __html: `${countryLabels[2]}` }}
                  ></div>
                }
              ...
              <FormControlLabel
                ...
                label={
                  <div
                    dangerouslySetInnerHTML={{ __html: `${countryLabels[3]}` }}
                  ></div>
                }
