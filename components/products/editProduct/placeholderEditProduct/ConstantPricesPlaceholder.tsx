...
import {
  ...
  OuterContainer,
  StyledTableCell,
} from "../productInformation/activePassive/active/constantPrices/styles";
import {
  HeaderCustomSpecs,
  HeaderMainText,
  HeaderSubText,
} from "../productInformation/activePassive/active/customSpecs/styles";
import ConstantListSkelton from "../productInformation/activePassive/active/constantPrices/ConstantsListSkelton";
...
export const ConstantPricesPlaceholder = () => {
  ...
  const { commercialInfoCurrencies, commercialInfoUnits, productDetail } = useSelector(
  ...
  let formik: any = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        formData.append("constant_name", values?.constant_name);
        formData.append("constant_value", values?.constant_value);
  ...
  const handleSelectParamter = (newValue: any) => {
    if (!newValue) {
      // If the value is cleared, reset the field and error
  ...
  const handleSelectParamterUnit = (newValue: any) => {
    ...
    // Clear existing errors and set the new value
    formik.setFieldError("parameterUnit", "");
      ...
      <OuterContainer>
        ...
        <FieldsContainer sx={{ paddingTop: "16px" }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={2} sm={12} md={3} lg={1}>
              <FormControl sx={{}}>
                <div
                  style={{
                    // width: "90px",
