...
import AddUnitFieldPlaceholder from "./AddUnitFieldPlaceholder";
import HidePriceOptions from "../commercialInformation/HidePriceOptions";

export const FixedPricingPlaceholder = ({
  formik,
  availability,
  commercialUnitList,
  ...
  //   HandlePercentage("commrecial_fixed_currency", currency_id > 0 ? currency : 0);
  //   HandlePercentage("commrecial_fixed_shipping_incoterm", price_term.length > 0 ? shippingIncoterms : 0);
  //   setComponentSourceToggle(formik?.values?.negotiable_price);
  // }, [quantity_available, unit, price_term, unit_price, currency_id]);
                ...
                >
                  <ToggleButton
                    ...
                    onClick={(e) => {
                      ...
                      formik.setFieldError("unit_price", "");
                    }}
                  >
                    Show
                  </ToggleButton>
