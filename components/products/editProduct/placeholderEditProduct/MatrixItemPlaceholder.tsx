...
import { SaveCancelIconbox } from "../../editProduct/productInformation/activePassive/active/customSpecs/styles";
import SaveOutlinedIcon from "@mui/icons-material/SaveOutlined";
import TablePagination from "@mui/material/TablePagination";
import CustomPagination from "@/components/common/CustomPagination";
import { PaginationBox } from "../../editProduct/productInformation/activePassive/active/specMatrix/styles";
export const MatrixItemPlaceholder = (props) => {
  const productId = props?.productId;
  const [priceValue, setPriceValue] = useState<any>({});
  const [defaultvalue, setDefaultValue] = useState("");
  const [delId, setDeleteId] = useState("");
  const { matrixItems, totalVariation, matrixListPage, matrixTableLoader } =
            ...
            {matrixItems
              ...
              .map((element, index) => (
                ...
                >
                  ...
                  <TableCell>
                    <Typography sx={{ fontSize: "14px" }}>
                      {productDetail?.stock_keeping_unit}_
                      {(index + 1 + (matrixListPage - 1) * 10)
                        .toString()
                        .padStart(4, "0")}
                    </Typography>
