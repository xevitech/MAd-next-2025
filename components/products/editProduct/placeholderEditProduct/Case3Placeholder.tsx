...
// import { DeleteButton } from "../rightStaticContent/UploadProducts/styles";

function Case3Placeholder({ formik, productDetail }) {
  ...
  let labelText = (i) => {
    ...
    return `For <strong>${
      originCountry?.view ?? ""
    }</strong> orders product made in <strong>${
      madeInCountry?.view ?? ""
    }</strong>.`;
  };
                    ...
                    <Typography variant="h6">
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: `For <strong>${
                            [...modifiedCountriesList, ...territoryData].find(
                              (item) =>
...
export default Case3Placeholder;
