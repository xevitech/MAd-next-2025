...
import ProductSkeleton from "../productCategories/Skeleton";
...
export const ProductCategoriesPlaceholder = ({
  refetchlist,
  setRetchList,
  setDescriptionBlock,
  setCompletedFields,
                                              ...
                                              {userId &&
                                                ...
                                                (() => {
                                                  switch (
                                                    ...
                                                    case 0:
                                                      return <PendingCategory>(Pending for approval)</PendingCategory>;
                                                    case 1:
