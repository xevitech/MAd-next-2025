...
import { AddButton, Buttonspacing, DeleteButton } from "../commercialInformation/styles";
const OtherComponentPlaceholder = (props) => {
  const {
    formik,
    // componentName,
    // setComponentName,
...
export default OtherComponentPlaceholder;
