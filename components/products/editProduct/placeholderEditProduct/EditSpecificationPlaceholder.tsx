...
function EditSpecificationPlaceholder({ data, editChoice, handle }: any) {
  ...
  const onSubmitHandler = async () => {
    ...
    formData.append("name", editedAttributeName);
        ...
        <span>
          ...
          >
            <LightTooltip arrow disableInteractive placement="top" title="Save">
              <CheckOutlinedIcon
                sx={{ color: "#d7282f !important", fontSize: "14px" }}
              />
            </LightTooltip>
          </Box>
          <Button
...
export default EditSpecificationPlaceholder;
