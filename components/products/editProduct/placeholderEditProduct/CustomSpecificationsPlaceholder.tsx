...
import { BtnContainer, CustomButtonCustomSpecs, HeaderCustomSpecs, HeaderMainText, HeaderSubText, InputFieldContainer, OuterContainerCustomSpecs, SpecificationsListContainer } from "../productInformation/activePassive/active/customSpecs/styles";
import { SingleCustomSpecification } from "../productInformation/activePassive/active/customSpecs/SingleCustomSpecification";
export const CustomSpecificationsPlaceholder = ({
  setCompletedFields,
  setCommercialBlock,
  setAccordianValue,
  category_lists,
