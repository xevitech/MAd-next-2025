...
import { ComNameLogoInfo, CompanyOriginInfo, CompanyProductItem, CompanyProductList, SecrorMinMaxOrder, TopRatedCompaniesBox, TopRatedCompaniesInner } from "../style";
